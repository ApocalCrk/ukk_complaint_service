...
function initSearch() {
  $('.search-input').each(function () {
    $(this).on('keyup', function () {
      ...
      $.getJSON('/masyarakat/pengaduan/data_ped', function (data) {
        $container.find('.search-results .search-result, .search-results .placeholder-wrap').remove();
        $.each(data, function (key, value) {
          if (value.judul_laporan.search(expression) != -1 || value.status.search(expression) != -1) {
              var template = "\n                                    <a class=\"search-result\" href=\"/masyarakat/pengaduan/" + value.id + "\">\n                                        <div class=\"h-avatar is-small\">\n                                            <img class=\"" + 'article' + "\" src=\"../storage/" + value.foto + "\" alt=\"\">\n                                        </div>\n                                        <div class=\"meta\">\n                                            <span> Judul Aduan : " + value.judul_laporan + "</span>\n                                            <span>" + value.tgl_pengaduan + "</span>\n                                        </div>\n                                    </a>\n                                ";
