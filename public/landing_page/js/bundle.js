...
function initApp() {
  return {
    ...
    setupGlider: function setupGlider() {
      var glider = new Glider(document.querySelector(".testimonials-glider"), {
        slidesToShow: 1,
        slidesToScroll: 1,
        draggable: true,
        arrows: {
...
function initPageLoader() {
  window.addEventListener('load', function () {
    ...
    var heroImageLight = document.querySelector('.hero-image.light-image');
    var heroImageDark = document.querySelector('.hero-image.dark-image');
    var heroCaption = document.querySelector('.hero-caption');
    var CaptionTitle = heroCaption.querySelector('.title');
    var CaptionSubTitle = heroCaption.querySelector('.subtitle');
    var CaptionControl = heroCaption.querySelector('.control');
...
var _app = require("./libs/app/app");

var feather = require('feather-icons');

window.initApp = _app.initApp;
...
},{"./libs/app/app":4,"./libs/components/pageloader":5,"./libs/utils/constants":6,"./libs/utils/utils":7,"./store/store":9,"alpinejs":2,"feather-icons":3}],9:[function(require,module,exports){
"use strict";
